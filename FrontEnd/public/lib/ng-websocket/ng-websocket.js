...
(function () {
    ...
    function $websocketService (cfg, $http) {
        ...
        wss.$get = function (url, channelType) {
            var ws_key = url + "|" + channelType;
            return wss.$$websocketList[ws_key];
        };
        ...
        wss.$new = function (cfg) {
            ...
            if (typeof ws === 'undefined') {
                ...
                var ws_key = wsCfg.url + "|" + wsCfg.channelType;
                wss.$$websocketList[ws_key] = ws;
            }
